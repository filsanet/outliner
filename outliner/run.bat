...
:: java -cp %CP% -Duser.language=ja -Duser.region=JP -Xincgc com.organic.maynard.outliner.Outliner ja
:: java -cp %CP% -Duser.language=de -Duser.region=DE -Xincgc com.organic.maynard.outliner.Outliner de
:: java -cp %CP% -Duser.language=es -Duser.region=ES -Xincgc com.organic.maynard.outliner.Outliner es

::java -cp %CP% -Xincgc com.organic.maynard.outliner.Outliner en "%1"
%JAVA_HOME%\bin\java -cp %CP% -Xincgc com.organic.maynard.outliner.Outliner en "%1"
::c:\jdk1.3.1\bin\java -cp %CP% -Xincgc com.organic.maynard.outliner.Outliner en "%1"
